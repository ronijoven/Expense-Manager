                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.expense-categories.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('expense_category_desc') ? 'has-error' : '' }}">
                            <label class="form-label" for="expense_category_desc">{{ trans('cruds.expenseCategory.fields.expense_category_desc') }}</label>
                            <input class="form-control" type="text" name="expense_category_desc" id="expense_category_desc" value="{{ old('expense_category_desc', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('expense_category_display') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="expense_category_display" id="expense_category_display" value="{{ old('expense_category_display', '') }}" required>
