                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.expenses.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('expense_money') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="expense_money" id="expense_money" value="{{ old('expense_money') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('expense_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="expense_date" id="expense_date" value="{{ old('expense_date') }}" required>
